...
def validate_args(args, defaults={}):
    ...
    if args.num_waves_per_pipeline is not None:
        assert args.num_layers_per_virtual_pipeline_stage is None, \
            'must choose one between virtual pipeline & wpp'
    ...
    # if torch.distributed.get_rank() == 0:
        print('virtual pp', args.virtual_pipeline_model_parallel_size)
        print('num layers per virtual pp stage', args.num_layers_per_virtual_pipeline_stage)
    else:
...
def _add_distributed_args(parser):
    ...
    group.add_argument('--pipeline-1f1b-enable', type=int, default=1,
                       help='GPipe or 1F1B')
